...
<form action="customerbooksort.php" method="post"><span class="sort2"><input type="submit" name="book" value="Sort by Book Name"> </span></form>
<form action="customerauthorsort.php" method="post"><span class="sort2"><input type="submit" name="date" value="Sort by Author Name"> </span></form>
