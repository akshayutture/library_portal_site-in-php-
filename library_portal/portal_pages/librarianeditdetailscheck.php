...
mysqli_query($con,"UPDATE Librarians SET password='".$_POST['password']."',email='".$_POST['email']."', phone_number='".$_POST['phonenumber']."' WHERE librarian_name='".$_SESSION['user'][0]."'");
...
<div id="login">
<br>
<h2> Librarian Successful Edit Details Page</h2>
<br>
<h3> Details Successfully edited </h3><br><br>
