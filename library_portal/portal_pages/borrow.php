...
mysqli_query($con,"UPDATE Customers SET book_borrowed_name='".$_POST['book']."'WHERE customer_name='".$_SESSION['user'][0]."'");
mysqli_query($con,"UPDATE Books SET borrowed_by='".$_SESSION['user'][0]."'WHERE book_name='".$_POST['book']."'");
$_SESSION['user'][4]=$_POST['book'];
?>
...
<div id="login">
<br>
<h2> Customer Borrow Page</h2>
<br>
<h3> Book successfully borrowed. <br>Remember: You need to return a book before you can borrow another </h3>
