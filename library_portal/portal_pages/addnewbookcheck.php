...
mysqli_query($con,"INSERT INTO Books (book_name, book_author, book_publisher,date_added) VALUES ('".$bookname."', '".$author."','".$publisher."','".date('Y-m-d')."')");
?>
...
<div id="login">
<br>
<h2> Librarian Successful Add Book Page</h2>
<br>
