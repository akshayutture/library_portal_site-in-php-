...
<form action="librarianauthorsort.php" method="post"><span class="sort2"><input type="submit" name="author" value="Sort by Author Name"> </span></form>
<form action="librariandatesort.php" method="post"><span class="sort2"><input type="submit" name="date" value="Sort by Date Added"> </span></form>
