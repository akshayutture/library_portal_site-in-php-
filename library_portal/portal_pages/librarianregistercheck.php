...
header("location:librarianregister.html");
}
...
$sql="SELECT * FROM Librarians WHERE librarian_name='$name'";
...
{
mysqli_query($con,"INSERT INTO Librarians (librarian_name, password, phone_number,email) VALUES ('".$name."', '".$password."','".$email."','".$phonenumber."')");
$status='Successful';
...
<div id="login">
<br>
<h2> Librarian <?php echo $status; ?> Registration Page</h2>
<br>
