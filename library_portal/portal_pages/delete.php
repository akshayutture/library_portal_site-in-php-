...
mysqli_query($con,"DELETE FROM Books WHERE book_name='".$_POST['book']."'");
...
<div id="login">
<br>
<h2> Librarian Delete Page</h2>
<br>
<h3> Book successfully Deleted </h3>

<a href="librarianbooksort.php"><div id="goback">Click here to go back to Librarian Portal</div></a> 
